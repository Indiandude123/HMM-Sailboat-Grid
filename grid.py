...
class Grid:
    ...
    def plot_sensor_probabilities_heatmap(self, probabilities, sensor_no, path=None):
        """
        Visualize the sensor detection probabilities as a heatmap.
        """
        plt.figure(figsize=(10, 8))
        cmap = sns.color_palette("viridis", as_cmap=True)
        sns.heatmap(probabilities, annot=False, cmap=cmap, cbar=True, vmin=0, vmax=1)
        plt.title("Sensor Detection Probabilities Heatmap for sensor "+ str(sensor_no+1))
